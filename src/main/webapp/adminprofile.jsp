	...
	<div>
		<nav class="navbar">
			...
			<div class="navbar-buttons">
				<a href="/homeadmin" class="navbar-button">Home</a>
			</div>
				...
				<form action="/updateProfile" method="post">
					<div class="form-group">
						<label for="name">Name</label> <input type="text" id="name"
							value="${u.name}" placeholder="First name">
					</div>
					<div class="form-group">
						<label for="modile">Mobile Number</label> <input type="tel"
							id="mobile" value="${u.mobile}" placeholder="Enter phone number">
					</div>
					<div class="form-group">
						<label for="address1">Address Line 1</label> <input type="text"
							id="address1" value="${u.address1}"
					...
					<div class="form-group">
						<label for="email">Email ID</label> <input type="email" id="email"
							value="${u.email}" placeholder="Enter email ID">
					</div>
					<div class="form-group">
