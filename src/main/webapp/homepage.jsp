...
<body>
		...
		<nav class="navbar">
			...
			<div class="navbar-buttons">
				<a href="/progress" class="navbar-button">Progress</a> <a
					href="/mentors" class="navbar-button">Mentors</a> <a
	...
	<div class="container">
		...
		<div class="front2">
			...
			<h3>With Mentors from all domains</h3>
		</div>
		<div class="mentor-carousel">
			<div class="carousel-container">
				<div class="carousel-slide">
					<img
						src="https://img.freepik.com/free-vector/young-prince-royal-attire_1308-176144.jpg"
						alt="Mentor 1" class="mentor-image"> <img
						src="https://img.freepik.com/free-vector/young-prince-vector-illustration_1308-174367.jpg"
						alt="Mentor 2" class="mentor-image"> <img
						src="https://img.freepik.com/free-vector/smiling-blonde-boy-hoodie_1308-174731.jpg"
						alt="Mentor 3" class="mentor-image"> <img
						src="https://img.freepik.com/free-vector/smiling-young-man-hoodie_1308-176157.jpg"
