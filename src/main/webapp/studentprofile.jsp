...
<body>
    ...
    <div>
        <nav class="navbar">
            ...
            <div class="navbar-buttons">
                ...
                <a href="/mentors" class="navbar-button">Mentors</a>
            </div>
    ...
    <div class="container">
        <div class="sidebar">
            <img src="${u.profilePictureUrl}" alt="Profile Picture" />
            ...
            <div class="form-section">
                ...
                <form action="/updateProfile" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" value="${u.name}" placeholder="First name">
                    </div>
                    <div class="form-group">
                        <label for="modile">Mobile Number</label>
                        <input type="tel" id="mobile" value="${u.mobile}" placeholder="Enter phone number">
                    </div>
                    <div class="form-group">
                        <label for="address1">Address Line 1</label>
                        <input type="text" id="address1" value="${u.address1}" placeholder="Enter address line 1">
                    </div>
                    <div class="form-group">
                        <label for="address2">Address Line 2</label>
                        <input type="text" id="address2" placeholder="Enter address line 2">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" value="${u.email}" placeholder="Enter email ID">
                    </div>
                    <div class="form-group">
